...
<ul
    class="mt-1 list-decimal pl-12 pr-8 text-justify font-body text-sm leading-snug text-body sublist"
>
...
<ul
    class="mt-1 list-['—_'] pl-12 pr-8 text-justify font-body text-sm leading-snug text-body sublist"
>
